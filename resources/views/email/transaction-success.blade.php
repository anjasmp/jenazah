                              ...
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                <tr>
                                  <td align="center" bgcolor="#038e81" role="presentation" style="border:none;border-radius:10px;cursor:auto;mso-padding-alt:10px 25px;background:#038e81;" valign="middle">
                                    <a href="{{ url('member/transaksi/pay/' . $data->id ) }}"><p style="display:inline-block;background:#038e81;color:#ffffff;font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:10px;"> Detail Pembayaran </p></a>
                                  </td>
                                </tr>
                              </table>
                            </td>
          ...
          <![endif]-->
              <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;padding-right:25px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvetica, Arial, sans-serif;font-size:18px;line-height:20px;text-align:left;color:#038e81;">Butuh Bantuan?</div>
                    </td>
                  </tr>
                </table>
              </div>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                      <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;table-layout:auto;width:100%;border:none;">
                        <tr>
                          <td style="width: 50px;">
                            <img src="{{ url('user/assets/img/ic_support@2x.png')}}" width="50px">
                          </td>
                          <td style="font-size: 18px; padding-left: 10px; color: #000000;font-family: Assistant, Helvetica, Arial, sans-serif"> support@masjidbaitulhaqpurigading.com <br> <a href="https://wa.me/message/EMV4ZHEQ3PB7M1" target="_blank" style="text-decoration: none"> 0852 1327 4473</a>(WhatsApp Center) </td>
                        </tr>
                      </table>
                    </td>
                  </tr>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:30px;padding-right:25px;padding-bottom:0px;padding-left:25px;word-break:break-word;">
                      <div style="font-family:Assistant, Helvetica, Arial, sanf-serif;font-size:18px;line-height:1;text-align:center;color:#888B93;">2020 Masjid Baitul Haq Copyright All Rights Reserved.</div>
                    </td>
                  </tr>
                </table>
              </div>

...
<div class="card-body" style="box-shadow: 0 10px 29px 0 rgba(68, 88, 144, 0.1); padding-bottom: 70px;">
    ...
    <form class="mt-4" action="{{ route('post.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <button class="btn btn-primary" style="float: right;">Save Post</button>
        </div>
    </form>

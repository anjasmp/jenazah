...
class TagController extends Controller
{
    ...
    {
        $tag = Tags::orderBy('id')->get();
        return view('admin.acarainfo.tag.index', compact('tag'));
    }
    ...
    {
        return view('admin.acarainfo.tag.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.acarainfo.tag.edit', compact('tags'));
    }
